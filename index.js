...
function loadSkis(skisList) {
    ...
    for (var i = 0; i<skisList.skis.length; i++){
        ...
        anchorElement.href = "path/to/react-page.html"; 
        ...
        else if (url == "ski2.jpeg") {
            j = 2
        }
        else if (url == "ski3.jpeg") {
            j = 3
        }

        else if (url == "ski4.jpeg") {
            j = 4
        }

        else if (url == "ski5.jpeg") {
            j = 5
        }

        else if (url == "ski6.jpeg") {
            j = 6
        }

        else if (url == "ski7.jpeg") {
            j = 7
        }

        else if (url == "skigrey.jpg") {
            j = 8
        }

        // create Bootstrap card

        // was just this <img src=${url} class="card-img-top" alt="..."></img> and then card body below
       let sendLink = "http://localhost:3000/skiDetails/" + j;
